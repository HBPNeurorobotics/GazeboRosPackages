...
class PubLWA4PTarget:
    def __init__(self):
        ...
        #gripper_left_topic = rospy.get_param('~gripper_left_topic', '/lwa4p/gripper_left_effort_controller/command')
        #gripper_right_topic = rospy.get_param('~gripper_right_topic', '/lwa4p/gripper_right_effort_controller/command')
