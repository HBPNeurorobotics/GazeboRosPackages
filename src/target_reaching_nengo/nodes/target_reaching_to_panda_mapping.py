...
class TargetReachingToKUKAMapping:
    def __init__(self):
        ...
        self.received_joint_cmds_pub = rospy.Publisher('/panda/received_joint_cmds', String, queue_size=1)
        ...
        self.move_to_standby_server = rospy.Service('/panda/move_to_standby', Trigger, self._move_to_standby)
